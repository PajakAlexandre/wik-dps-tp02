...
```bash
docker run -e PING_LISTEN_PORT=8081 -p 8081:8081 rust_api_signle_stage:latest
```
## Security scan
```bash
❯ trivy rust_api_signle_stage:1.0
...
rust_api_signle_stage:1.0 (debian 10.13)
========================================
